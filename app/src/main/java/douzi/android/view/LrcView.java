...
public class LrcView extends View implements ILrcView{
	...
	private int mLrcFontSize = 40;//23; 	// font size of lrc
	private int mMinLrcFontSize = 15; //15
	private int mMaxLrcFontSize = 23;  //23
	private int mPaddingY = 10;		// padding of each row
	private int mSeekLinePaddingX = 0; // Seek line padding x
	private int mDisplayMode = DISPLAY_MODE_SCALE;
